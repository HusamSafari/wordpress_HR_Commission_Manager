# Yam_human_mangament_sytem (SWVT-HR)
...
`Yam_human_mangament_sytem` is a robust HR and ERP-style management plugin designed for businesses with multiple branches. It streamlines employee records, tracks organizational hierarchies, logs granular attendance details, and calculates complex sales commissions dynamically.
...
`Yam_human_mangament_sytem` هي إضافة ووردبريس قوية مخصصة لإدارة الموارد البشرية (HR) والعمليات المالية للشركات ذات الفروع المتعددة. تسهل الإضافة إدارة سجلات الموظفين، تتبع الهياكل الإدارية، تسجيل تفاصيل الغياب اليومية، واحتساب عمولات المبيعات بديناميكية متكاملة.
